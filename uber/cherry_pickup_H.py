class Solution:
    def cherryPickup(self, grid: List[List[int]]) -> int:
        ...
        def dfs(r1, c1, r2):
            ...
            # check out of bounds for dfs and for thorns in the grid
            ...
            # add the current grid cherry value for person 2 if we didnt add it for person 1, essentially different value
            if (r1,c1)!=(r2,c2):
                res += grid[r2][c2]
